...
export default function DondeEstamos() {
  ...
  return (
    <section className="bg-gray-50 py-16 px-6">
      <div className="max-w-4xl mx-auto space-y-10 text-center md:text-left" data-aos="fade-up">
        {/* Icono + Título */}
        <div className="flex flex-col items-center md:items-center space-y-2" data-aos="fade-down">
        ...
        {/* Dirección */}
        <div className="space-y-4 flex flex-col items-center md:items-center" data-aos="fade-up">
          ...
          <p className="text-lg font-semibold text-primary text-center md:text-center">
            C/ Albaicín, nº 2-A, oficina 2 <br /> Bormujos (Sevilla)
          </p>
        ...
        {/* Mapa */}
        <div className="rounded-xl overflow-hidden shadow-lg" data-aos="zoom-in-up">
          <iframe
