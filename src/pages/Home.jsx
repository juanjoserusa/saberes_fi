...
<section className="relative h-[400px] md:h-[500px] text-white flex items-center justify-center text-center px-4 overflow-hidden">
  {/* Imagen de fondo */}
  <img
    src="/src/assets/hero.jpg"  // Asegúrate de que esté copiada ahí
    alt="Alumno estudiando"
    className="absolute inset-0 w-full h-full object-cover object-center opacity-40"
  />
  {/* Capa azul oscuro translúcida */}
    ...
    >
      ...
      <section className="mt-20 text-center px-6">
        ...
        <div className="max-w-3xl mx-auto text-gray-700 text-lg space-y-6">
          ...
          <p>
            Hacemos un <span className="font-semibold" style={{ color: '#D4B400' }}>
  seguimiento global
</span>, estamos pendientes de la evolución de todas las asignaturas, priorizando aquellas en las que el alumno tiene dificultades, siempre con la vista puesta en aprovechar al máximo el tiempo para que los resultados en los exámenes sean satisfactorios para todos.
          </p>
        </div>
      </section>
    </div>
